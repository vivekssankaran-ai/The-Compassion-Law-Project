          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 border-b border-cream/10 pb-16 mb-12">
            ...
            <div className="md:col-span-5 space-y-6">
              ...
              <div className="flex gap-4 pt-2">
                <a href="mailto:vivekssankaran@gmail.com" className="w-10 h-10 rounded-full bg-cream/10 flex items-center justify-center hover:bg-terracotta hover:text-cream transition-all duration-300">
            ...
            <div className="md:col-span-4">
              ...
              <div className="space-y-4">
                <a href="mailto:vivekssankaran@gmail.com" className="group flex items-center gap-3 hover:text-terracotta transition-colors">
                  ...
                  <span className="text-sm">vivekssankaran@gmail.com</span>
                </a>
