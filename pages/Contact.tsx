    ...
    <div className="bg-cream min-h-[80vh] py-24 md:py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-serif font-bold text-sage mt-4 mb-6">Let's Connect</h1>
        ...
        <div className="grid md:grid-cols-5 gap-10 lg:gap-16 items-start">
          ...
          <div className="md:col-span-2 space-y-10">
            <div className="group p-8 bg-gradient-to-br from-cream to-cream-darker rounded-xl border border-sage/10 hover:border-terracotta/20 hover:shadow-xl transition-all duration-500">
              <div className="w-12 h-12 rounded-xl bg-sage/10 flex items-center justify-center mb-6 group-hover:bg-terracotta/10 transition-colors">
                <svg className="w-6 h-6 text-sage group-hover:text-terracotta transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="p-8 bg-sage/5 rounded-xl border border-sage/10">
              <h3 className="font-serif text-xl font-bold text-sage mb-4">What to expect</h3>
          ...
          <div className="md:col-span-3 relative">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h2 className="font-serif text-2xl font-bold text-sage">Send a Message</h2>
              </div>
